...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_walk_dog_walk_id")
                            .from(Alias::new("walk_dog"), Alias::new("walk_id"))
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(Alias::new("walk_dog"), Alias::new("dog_id"))
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_walk_dog_walk_id_dog_id")
                    .table(Alias::new("walk_dog"))
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table("walk_dog").to_owned())
            .await
    }
}
