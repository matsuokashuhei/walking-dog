...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_walk_dog_event_walk_dog_id")
                            .from(Alias::new("walk_dog_event"), Alias::new("walk_dog_id"))
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_walk_dog_event_walk_dog_id_occurred_at")
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table("walk_dog_event").to_owned())
            .await?;
