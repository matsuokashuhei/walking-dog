...
import { colors, elevation, radius, shadow } from '@/theme/tokens';
...
const APP_MARK_GRADIENT = [colors.light.success, colors.light.interactive] as const;
const APP_MARK_ELEVATION = {
