...
type ContactChromeButtonShape = 'circle' | 'pill';

interface ContactChromeButtonProps {
  shape: ContactChromeButtonShape;
  label: string;
  onPress: () => void;
...
export function ContactChromeButton({
  shape,
  label,
  onPress,
  iconName,
